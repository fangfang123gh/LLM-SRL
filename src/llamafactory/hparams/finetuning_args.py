...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    """
    correct_step: int = field(
        default=-1,
        metadata={"help": "When to correct."},
    ) 
    pred_correct: bool = field(
        default=False,
        metadata={"help": "Whether or not to train model with predicate correction."},
    )
    argument_correct: bool = field(
        default=False,
        metadata={"help": "Whether or not to train model with argument correction."},
    )
    pred_correct_prompt: str = field(
        default='',
        metadata={"help": "What predicate correction prompt will be used."},
    )
    argument_correct_prompt: str = field(
        default='',
        metadata={"help": "What argument correction prompt will be used."},
    )
